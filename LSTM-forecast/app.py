...
os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = "lstm-spm-587-9a7d5876e065.json"
...
def forecast():
    ...
    """
    BASE_IMAGE_PATH = os.environ.get("BASE_IMAGE_PATH", "_")
    ...
    BUCKET_NAME = os.environ.get("BUCKET_NAME", "_")
